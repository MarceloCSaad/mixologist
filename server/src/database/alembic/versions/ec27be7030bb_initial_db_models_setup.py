...
def upgrade() -> None:
    ...
    sa.Column('glassware', sa.Enum('MARGARITA', 'MARTINI', 'COCKTAIL', 'HIGHBALL', 'COLLINS', 'COUPE', 'HURRICANE', 'SHOT', 'OLD_FASHIONED', 'SNIFTER', 'NICK_AND_NORA', 'IRISH_COFFEE', 'COPPER_MUG', 'SOUR', 'CORDIAL', 'LOWBALL', 'WINE', 'CHAMPAGNE', 'TIKI', 'BEER_MUG', 'PINT', 'GLENCAIRN', 'JULEP', name='cocktailglassware'), nullable=False),
    ...
    op.create_table('cocktail_tag_association',
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('action', sa.Enum('ADD_INGREDIENT', 'MUDDLE', 'SHAKE', 'BLEND', 'STIR', 'POUR', 'PEEL', 'GRATE', 'DECORATE', name='stepaction'), nullable=False),
    sa.Column('ingredient_id', sa.Integer(), nullable=True),
    sa.Column('measuring_unit', sa.Enum('ML', 'OZ', 'KG', 'LB', 'DASH', 'TSP', 'TBSP', 'CUP', 'PINT', 'QUART', 'GALLON', 'LITER', 'GRAM', 'SLICE', 'WEDGE', 'PIECE', 'CUBE', 'LEAF', 'PINCH', name='measuringunit'), nullable=True),
    sa.Column('quantity', sa.Float(), nullable=True),
    sa.Column('mixology_tool', sa.Enum('COCKTAIL_SHAKER', 'HAWTHORNE_STRAINER', 'JULEP_STRAINER', 'FINE_MESH_STRIANER', 'PEELER', 'GRATER', 'BLENDER', 'MUDDLER', 'JIGGER', 'STIRRING_SPOON', 'STIRRING_JAR', name='mixologytool'), nullable=True),
